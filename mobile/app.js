    ...
    state.habits.forEach((habit) => {
      ...
      card.innerHTML = `
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 8px;">
          ...
          <button class="ghost-button compact-button" type="button" data-check-21day="${habit.id}" style="font-size: 0.78rem; padding: 6px 12px; border-radius: 10px; font-weight: 700; ${doneToday ? 'background:rgba(0,255,208,0.15);color:#00ffd0;border-color:#00ffd0;' : 'color:#00f6ff;border-color:rgba(0,246,255,0.4);'}">
